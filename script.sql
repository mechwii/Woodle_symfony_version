...
VALUES
    ('Salut la team zer', 'Une analyse des ...', 'Contenu détaillé de la publication...', '2025-04-19 10:00:00', TRUE, 1, 2, 1, 'IA41'),
    ('Apaya', 'Une étude approfondie des.', 'Contenu détaillé de la publication...', '2025-04-19 11:00:00',  TRUE, 2, 3, 1, 'IA41'),
    ('Quoicoubeh', 'Un regard sur l’évolution de.', 'Contenu détaillé de la publication...', '2025-04-19 12:00:00',  TRUE, 3, 5, 1, 'IA41');
...
INSERT INTO publication (titre, description, contenu_texte, derniere_modif, visible, section_id, utilisateur_id, type_publication_id, code_id)
VALUES
    ('Architecture BD', 'Présentation de l’architecture.', 'Contenu détaillé...', '2025-04-20 09:00:00', TRUE, 4, 2, 1, 'BD4J'),
    ('Indexation efficace', 'Accélérer les requêtes SQL.', 'Contenu détaillé...', '2025-04-20 10:00:00', TRUE, 5, 2, 3, 'BD4J'),
    ('Sécurité des données', 'Sécuriser l’accès aux données.', 'Contenu détaillé...', '2025-04-20 11:00:00', TRUE, 6, 2, 4, 'BD4J');
...
VALUES
    ('Fichier important', 'Fichier à télécharger', 'crypto.zip', '2025-04-20 09:10:00', TRUE, 4, 2, 2, 'BD4J');


-- Publications pour ML6I
INSERT INTO publication (titre, description, contenu_texte, derniere_modif, visible, section_id, utilisateur_id, type_publication_id, code_id)
VALUES
    ('Introduction au Machine Learning', 'Notions de base en apprentissage automatique.', 'Contenu détaillé...', '2025-04-21 09:00:00', TRUE, 7, 2, 1, 'ML6I'),
    ('Régression linéaire', 'Comprendre les modèles de régression.', 'Contenu détaillé...', '2025-04-21 10:00:00',  TRUE, 8, 2, 4, 'ML6I'),
    ('Arbres de décision', 'Utilisation des arbres pour la classification.', 'Contenu détaillé...', '2025-04-21 11:00:00', TRUE, 9, 2, 5, 'ML6I');
...
INSERT INTO publication (titre, description, contenu_texte, derniere_modif, visible, section_id, utilisateur_id, type_publication_id, code_id)
VALUES
    ('Réseaux informatiques', 'Les bases des réseaux et de l’interconnexion.', 'Contenu détaillé...', '2025-04-23 09:00:00',  TRUE, 13, 2, 4, 'RE4E'),
    ('Protocoles de communication', 'Exploration des protocoles réseau.', 'Contenu détaillé...', '2025-04-23 10:00:00',  TRUE, 14, 2, 3, 'RE4E'),
    ('Cybersécurité', 'Introduction à la sécurité des systèmes.', 'Contenu détaillé...', '2025-04-23 11:00:00', TRUE, 15, 2, 1, 'RE4E');
